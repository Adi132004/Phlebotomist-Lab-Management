...
<head>
    ...
    <title>PATHOLOGY LAB MANAGEMENT| Admin Login</title>
...
<body class="bg-gradient-primary">
 ...
 <h3 align="center" style="margin-top:4%;color:#fff">PATHOLOGY LAB MANAGEMENT</h3>
...
<form name="login" method="post">
                        <div class="row" >
                            <div class="col-lg-6 d-none d-lg-block"  >
                               <!-- <img src="img\pathology.jpg" width="500" height="400" > -->
                                <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
                               <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_0fhlytwe.json" background="transparent"  speed="1"  style="width: 400px; height: 400px;"  loop autoplay></lottie-player>
