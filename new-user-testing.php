...
<head>
    ...
    <title>PATHOLOGY LAB MANAGEMENT| New User Testing</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">PATHOLOGY LAB MANAGEMENT</h1>
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
                                            ...
                                            <option value="Antigen">Complete Blood Count Test</option>  
                                            <option value="RT-PCR">Urinalysis Test</option>
                                            <option value="CB-NAAT">Blood Sugar Test</option> 
